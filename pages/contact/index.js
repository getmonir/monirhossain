...
import { RiMailSendLine, RiMessengerFill, RiSkypeLine, RiWhatsappLine } from 'react-icons/ri';
const index = () => {
	return (
		<>
				...
				<div className='container'>
					<div className='row'>
						<div className='col-lg-7 text-center mx-auto'>
							...
							<p className='mb-0 lead'>I &apos;d love to find out more about your upcoming WordPress project. Get in touch today.</p>
						</div>
					</div>
				</div>
			</header>
