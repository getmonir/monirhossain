...
import { RiBehanceLine, RiFacebookCircleFill, RiGithubFill, RiInstagramLine, RiLinkedinFill, RiMailOpenFill, RiTwitterFill } from 'react-icons/ri';
const Footer = () => {
	return (
				...
				<div className='border-bottom border-white-10'>
					<div className='row align-items-center pt-8 pb-4'>
						<div className='col-md-8'>
							<h2 className='display-6 mb-3 mb-lg-0'>Download Best Seller Premium WordPress Themes</h2>
						</div>
						<div className='col-md-4'>
							<div className='text-lg-end'>
								<a className='btn btn-primary' href='https://1.envato.market/a1LYWo' target='_blank' rel='noreferrer'>
									Download Now
								</a>
							</div>
						</div>
					...
					<div className='row py-6'>
						<div className='col-6 col-sm-4 col-lg mb-5 mb-lg-0'>
							...
							<ul className='list-unstyled list-py-2 mb-0'>
								<li>
									<Link href='/about'>
										<a className='link-primary text-black text-decoration-none'>About Me</a>
									</Link>
								</li>

								<li>
									<Link href='/website-templates'>
										<a className='link-primary text-black text-decoration-none'>Free Website Templates</a>
									</Link>
								</li>
							</ul>
						</div>
						...
						<div className='col-6 col-sm-4 col-lg'>
							...
							<ul className='list-unstyled list-py-2 mb-0'>
								...
								<li>
									<a
										className='link-primary text-black text-decoration-none'
										href='https://facebook.com/monirhossain70'
										target='_blank'
										rel='noreferrer'
									>
										<div className='d-flex align-itmes-center'>
								...
								<li>
									<a
										className='link-primary text-black text-decoration-none'
										href='https://twitter.com/monirhossain70'
										target='_blank'
										rel='noreferrer'
									>
										<div className='d-flex align-itmes-center'>
								...
								<li>
									<a
										className='link-primary text-black text-decoration-none'
										href='https://instagram.com/monirhossain_com'
										target='_blank'
										rel='noreferrer'
									>
										<div className='d-flex align-itmes-center'>
								...
								<li>
									<a
										className='link-primary text-black text-decoration-none'
										href='https://linkedin.com/in/monirhossain70'
										target='_blank'
										rel='noreferrer'
									>
										<div className='d-flex align-itmes-center'>
								...
								<li>
									<a
										className='link-primary text-black text-decoration-none'
										href='https://github.com/monirhossain70'
										target='_blank'
										rel='noreferrer'
									>
										<div className='d-flex align-itmes-center'>
